...
class Board():
    ...
    def MinFlip(self,win):
        ...
        for i in range(2,6):
            for j in range(2,6):
                    if int(self.iflegal(0,0,win,0)) != 0 and self.bList[0][0]==-1:
                        Minflip=int(self.iflegal(0,0,win,0))
                        r=0
                        c=0
                    elif int(self.iflegal(0,7,win,0)) != 0 and self.bList[0][7]==-1:
                        Minflip=int(self.iflegal(0,7,win,0))
                        r=0
                        c=7
                    elif int(self.iflegal(7,7,win,0)) != 0 and self.bList[7][7]==-1:
                        Minflip=int(self.iflegal(7,7,win,0))
                        r=7
                        c=7
                    elif int(self.iflegal(7,0,win,0)) != 0 and self.bList[7][0]==-1:
                        Minflip=int(self.iflegal(7,0,win,0))
                        r=7
                        c=0
                    elif self.bList[i][j]==-1:
                        if int(self.iflegal(i,j,win,0))<Minflip and int(self.iflegal(i,j,win,0)) != 0:
        ...
        for i in range(2,6):
            for j in range(2,6):
                    if int(self.iflegal(0,0,win,0)) != 0 and self.bList[0][0]==-1:
                        ...
                        if (int(self.iflegal(i,j,win,0))>Maxflip) and (int(self.iflegal(i,j,win,0))!= 0):
